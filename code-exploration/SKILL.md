...
description: "代码探索技能 - 在修改代码前必须先理解代码库结构、依赖关系和现有实现。通过系统化的探索方法和知识图谱分析，快速建立对陌生代码的认知。"
---
...
参考 [graphify](https://github.com/safishamsi/graphify) 的设计理念，本技能支持将代码库转换为知识图谱，帮助快速理解项目结构和架构决策。
...
**使用场景：**
- writing-design 前：探索项目上下文，生成知识图谱
